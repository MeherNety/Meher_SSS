...
def internal_coookie_verification(msg):
	if(msg[0]=='i'):
		return True
	else:
		return False
...
def sign(cookie):
	...
	encrypt_bytes = base64.b64encode(cookie_bytes)
	encrypt_msg = encrypt_bytes.decode('utf-8')
	return encrypt_msg

def verify(cookie):
	cookie_bytes = cookie.encode('utf-8')
	decrypt_bytes = base64.b64decode(cookie_bytes)
	decrypt_msg = decrypt_bytes.decode('utf-8')
	verification = internal_coookie_verification(decrypt_msg)
	return verification
